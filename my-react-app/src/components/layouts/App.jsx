...
import {
  LayoutDashboard, User, Calendar, Leaf, Stethoscope, Package, CreditCard, Settings,
  Bell,           // add this
  Bell as BellIcon
} from 'lucide-react';
...
import DietPlansView from '../dietplans/DietPlansView';
import ConsultationsView from '../consultations/ConsultationsView';
                         ...
                         <div className="flex items-center gap-4">
                             ...
                             <div className="relative">
                                <button id="notification-button" onClick={() => setIsNotificationsOpen(prev => !prev)} className="relative">
                                     <BellIcon size={20} className="text-gray-300 hover:text-white cursor-pointer"/>
